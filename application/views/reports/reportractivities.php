    ...
    $(document).ready(function()
    {
    	$("button[name=btncetak]").click(function(e) 
        {
            $.ajax({
                type: "post",
                dataType: "json",
                url: "<?php echo base_url();?>reportspdf/printractivities",
        ...
        $("button[name=btnbatal]").on("click", function() 
        {
            $.ajax({
                type: "post",
                dataType: "html",
                url: "<?php echo base_url();?>reports/ractivities",
                beforeSend: function() {
        ...
        <?php if (getAccess($this->session->userdata('SESS_USER_ID'), 'L4', 'print') == 'N'):?>
