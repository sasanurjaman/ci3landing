...
<script type="text/javascript">
    $(document).ready(function()
    {
    	$("button[name=btncetak]").click(function(e) 
        {
			...
			var url = "<?php echo base_url();?>index.php/reports/printvideo";
        ...
        $("button[name=btnbatal]").on("click", function() 
        {
            $.ajax({
                type: "post",
                dataType: "html",
                url: "<?php echo base_url();?>index.php/reports/video",
                beforeSend: function() {
        ...
        <?php if ($this->sim_model->access($this->session->userdata('SESS_USER_ID'), 'L2', 'print') == 'N'):?>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>Judul</th>
                                <th class="end" width="8%">Status</th>
                            </tr>
                        </thead>
                        <tbody>
